...
const MovieDetails = [
  ...
  },
  {
    ...
    Actors:
      "Michael Fassbender, Michael Kenneth Williams, Marion Cotillard, Jeremy Irons",
    Plot: "Nine noble families wage war against each other in order to gain control over the mythical land of Westeros. Meanwhile, a force is rising after millenniums and threatens the existence of living men.",
    Language: "English",
    Country: "UK, France, USA, Hong Kong",
    Awards: "N/A",
    Poster:
  ...
  },
  {
    ...
    Actors:
      "Michael Fassbender, Michael Kenneth Williams, Marion Cotillard, Jeremy Irons",
    Plot: "Doctor Strange is a 2016 American superhero film based on the Marvel Comics character of the same name. Produced by Marvel Studios and distributed by Walt ...",
    Language: "English",
    Country: "UK, France, USA, Hong Kong",
    Awards: "N/A",
    Poster:
...
function App() {
  return (
    <>
      <div className="font-family: 'Poppins', sans-serif font-semibold p-3 border shadow-xl bg-gray-900 text-white flex justify-between">
        <h1 className="text-3xl ">Latest Movies</h1>
        <h3 className="font-mono">Page - 1</h3>
      </div>
      <div className=" container grid md:grid-cols-3 grid-cols-1 h-[75%] gap-2 mx-auto p-2">
